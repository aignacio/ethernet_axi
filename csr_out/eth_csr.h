...
#define ETH_CSR_RECV_FIFO_EMPTY_BIT_WIDTH 32
#define ETH_CSR_RECV_FIFO_EMPTY_BIT_MASK 0xffffffff
...
#define ETH_CSR_SEND_FIFO_EMPTY_BIT_WIDTH 32
#define ETH_CSR_SEND_FIFO_EMPTY_BIT_MASK 0xffffffff
